...
// Auth
export const login = (data: { username: string; password: string; company_id: number; period: string; is_admin?: boolean }) =>
...
export const createCompany = (data: { name: string; short_name?: string; industry?: string; internal_control_mode?: string; currency?: string }) =>
  api.post('/companies/', data)
export const updateCompany = (companyId: number, data: Record<string, any>) =>
...
export const getAccountBalance = (companyId: number) => api.get('/accounts/balance', { params: { company_id: companyId } })
export const createAccount = (data: { company_id: number; code: string; name: string; level: number; parent_code?: string; category: string; balance_direction: string; initial_balance?: number }) =>
...
// Vouchers
export const listVouchers = (companyId: number, params?: { start_date?: string; end_date?: string; voucher_no?: string; voucher_type?: string; status?: string }) =>
  api.get('/vouchers/', { params: { company_id: companyId, ...params } })
export const createVoucher = (data: { company_id: number; date: string; voucher_type: string; summary: string; entries: { account_code: string; department_id?: number; counterparty_id?: number; person_id?: number; project_id?: number; debit: number; credit: number; description?: string }[] }) =>
  api.post('/vouchers/', data)
export const updateVoucher = (voucherId: number, data: { summary?: string; date?: string; voucher_type?: string; entries?: { account_code: string; department_id?: number; counterparty_id?: number; person_id?: number; project_id?: number; debit: number; credit: number; description?: string }[] }) =>
...
export const reverseVoucher = (voucherId: number, reason: string) => api.post(`/vouchers/${voucherId}/reverse`, { reason })

// Periods
export const listPeriods = (companyId: number) => api.get('/periods/', { params: { company_id: companyId } })
export const closePeriod = (companyId: number, period: string) => api.post('/periods/close', { company_id: companyId, period })
...
// Reports
export const getBalanceSheet = (companyId: number, period: string) => api.get('/reports/balance', { params: { company_id: companyId, period } })
export const getIncomeStatement = (companyId: number, period: string) => api.get('/reports/income', { params: { company_id: companyId, period } })
export const getCashFlow = (companyId: number, period: string) => api.get('/reports/cashflow', { params: { company_id: companyId, period } })

// Cash-flow items
export const listCashFlowItems = (companyId: number) => api.get('/cashflow-items/', { params: { company_id: companyId } })
...
export const seedDefaultCashFlowItems = (companyId: number) => api.post('/cashflow-items/seed-defaults', null, { params: { company_id: companyId } })
...
export const printDepartments = (companyId: number) => api.get('/prints/departments', { params: { company_id: companyId } })
...
export const listCounterparties = (companyId: number) => api.get('/counterparties/', { params: { company_id: companyId } })
export const listPersons = (companyId: number, departmentCode?: string) =>
  api.get('/persons/', { params: { company_id: companyId, ...(departmentCode ? { department_code: departmentCode } : {}) } })
export const importAuxConfig = (companyId: number) => api.post('/accounts/import-aux-config', null, { params: { company_id: companyId } })

// Projects
export const listProjects = (companyId: number) => api.get('/projects/', { params: { company_id: companyId } })
export const createProject = (companyId: number, data: any) => api.post('/projects/', data, { params: { company_id: companyId } })
...
export const updateTransaction = (id: number, data: any) =>
  api.put(`/investments/transactions/${id}`, data)
...
export const updateAdjustment = (id: number, data: any) =>
  api.put(`/investments/adjustments/${id}`, data)
export const deleteAdjustment = (id: number) =>
  api.delete(`/investments/adjustments/${id}`)
...
export const updateInvestmentIncome = (id: number, data: any) =>
  api.put(`/investments/income/${id}`, data)
export const deleteInvestmentIncome = (id: number) =>
  api.delete(`/investments/income/${id}`)
...
export const listSecurities = (companyId: number, securityType?: string, exchange?: string) =>
  api.get('/investments/securities', { params: { company_id: companyId, ...(securityType ? { security_type: securityType } : {}), ...(exchange ? { exchange } : {}) } })
export const createSecurity = (companyId: number, data: any) =>
  api.post('/investments/securities', data, { params: { company_id: companyId } })
export const updateSecurity = (id: number, data: any) =>
  api.put(`/investments/securities/${id}`, data)
export const deleteSecurity = (id: number) =>
  api.delete(`/investments/securities/${id}`)

// Investment - Fund Management
export const listFunds = (companyId: number) => api.get('/investments/funds', { params: { company_id: companyId } })
export const createFund = (companyId: number, data: any) => api.post('/investments/funds', data, { params: { company_id: companyId } })
...
export const createCapitalAccount = (fundId: number, companyId: number, data: any) => api.post(`/investments/funds/${fundId}/capital-accounts`, data, { params: { company_id: companyId } })
export const updateCapitalAccount = (fundId: number, id: number, data: any) => api.put(`/investments/funds/${fundId}/capital-accounts/${id}`, data)
export const deleteCapitalAccount = (fundId: number, id: number) => api.delete(`/investments/funds/${fundId}/capital-accounts/${id}`)
export const listCapitalCalls = (fundId: number) => api.get(`/investments/funds/${fundId}/capital-calls`)
export const createCapitalCall = (fundId: number, companyId: number, data: any) => api.post(`/investments/funds/${fundId}/capital-calls`, data, { params: { company_id: companyId } })
export const updateCapitalCall = (fundId: number, id: number, data: any) => api.put(`/investments/funds/${fundId}/capital-calls/${id}`, data)
export const deleteCapitalCall = (fundId: number, id: number) => api.delete(`/investments/funds/${fundId}/capital-calls/${id}`)
export const listFundDistributions = (fundId: number) => api.get(`/investments/funds/${fundId}/distributions`)
export const createFundDistribution = (fundId: number, companyId: number, data: any) => api.post(`/investments/funds/${fundId}/distributions`, data, { params: { company_id: companyId } })
export const updateFundDistribution = (fundId: number, id: number, data: any) => api.put(`/investments/funds/${fundId}/distributions/${id}`, data)
export const deleteFundDistribution = (fundId: number, id: number) => api.delete(`/investments/funds/${fundId}/distributions/${id}`)
...
export const listHrEmployees = (companyId: number, status?: string, departmentId?: number) =>
  api.get('/hr/employees', { params: { company_id: companyId, ...(status ? { status } : {}), ...(departmentId ? { department_id: departmentId } : {}) } })
...
export const listHrSalaries = (companyId: number, employeeId?: number, yearMonth?: string) =>
  api.get('/hr/salaries', { params: { company_id: companyId, ...(employeeId ? { employee_id: employeeId } : {}), ...(yearMonth ? { year_month: yearMonth } : {}) } })
...
export const batchDeleteReceivables = (data: { ids: number[] }) =>
    api.post('/receivables/invoices/batch-delete', data)
...
export const updateAdminDocument = (id: number, data: any) =>
    api.put(`/admin/documents/${id}`, data)
export const deleteAdminDocument = (id: number) =>
...
export const issueDocument = (id: number) =>
    api.post(`/admin/documents/${id}/issue`)

// Vehicle Suppliers
export const listVehicleSuppliers = (companyId: number) =>
    api.get('/admin/vehicles/suppliers', { params: { company_id: companyId } })
export const createVehicleSupplier = (data: any) =>
    api.post('/admin/vehicles/suppliers', data)
export const updateVehicleSupplier = (id: number, data: any) =>
    api.put(`/admin/vehicles/suppliers/${id}`, data)
export const deleteVehicleSupplier = (id: number) =>
    api.delete(`/admin/vehicles/suppliers/${id}`)

// Vehicle Purchases
export const listVehiclePurchases = (companyId: number) =>
    api.get('/admin/vehicles/purchases', { params: { company_id: companyId } })
export const createVehiclePurchase = (data: any) =>
    api.post('/admin/vehicles/purchases', data)
export const updateVehiclePurchase = (id: number, data: any) =>
    api.put(`/admin/vehicles/purchases/${id}`, data)
export const deleteVehiclePurchase = (id: number) =>
    api.delete(`/admin/vehicles/purchases/${id}`)
...
export const createVehicleMaintenance = (data: any) =>
    api.post('/admin/vehicles/maintenance', data)
export const updateVehicleMaintenance = (id: number, data: any) =>
    api.put(`/admin/vehicles/maintenance/${id}`, data)
export const deleteVehicleMaintenance = (id: number) =>
    api.delete(`/admin/vehicles/maintenance/${id}`)
...
export const createInsurance = (data: any) =>
    api.post('/admin/insurance', data)
export const updateInsurance = (id: number, data: any) =>
    api.put(`/admin/insurance/${id}`, data)
export const deleteInsurance = (id: number) =>
    api.delete(`/admin/insurance/${id}`)
...
export const createStockCategory = (data: any) =>
    api.post('/admin/stock/categories', data)
export const updateStockCategory = (id: number, data: any) =>
    api.put(`/admin/stock/categories/${id}`, data)
export const deleteStockCategory = (id: number) =>
    api.delete(`/admin/stock/categories/${id}`)

// Stock Assets
export const listStockAssets = (companyId: number, status?: string, categoryId?: number) =>
    api.get('/admin/stock/assets', { params: { company_id: companyId, ...(status ? { status } : {}), ...(categoryId ? { category_id: categoryId } : {}) } })
export const createStockAsset = (data: any) =>
    api.post('/admin/stock/assets', data)
export const updateStockAsset = (id: number, data: any) =>
    api.put(`/admin/stock/assets/${id}`, data)
export const deleteStockAsset = (id: number) =>
    api.delete(`/admin/stock/assets/${id}`)

// Stock Purchases
export const listStockPurchases = (companyId: number) =>
    api.get('/admin/stock/assets/purchases', { params: { company_id: companyId } })
export const createStockPurchase = (data: any) =>
    api.post('/admin/stock/assets/purchases', data)
export const updateStockPurchase = (id: number, data: any) =>
    api.put(`/admin/stock/assets/purchases/${id}`, data)
export const deleteStockPurchase = (id: number) =>
    api.delete(`/admin/stock/assets/purchases/${id}`)
...
export const createStockRequisition = (data: any) =>
    api.post('/admin/stock/assets/requisitions', data)
export const updateStockRequisition = (id: number, data: any) =>
    api.put(`/admin/stock/assets/requisitions/${id}`, data)
export const deleteStockRequisition = (id: number) =>
    api.delete(`/admin/stock/assets/requisitions/${id}`)
...
export const createStockInbound = (data: any) =>
    api.post('/admin/stock/assets/inbound', data)
export const updateStockInbound = (id: number, data: any) =>
    api.put(`/admin/stock/assets/inbound/${id}`, data)
export const deleteStockInbound = (id: number) =>
    api.delete(`/admin/stock/assets/inbound/${id}`)
...
export const createStockOutbound = (data: any) =>
    api.post('/admin/stock/assets/outbound', data)
export const updateStockOutbound = (id: number, data: any) =>
    api.put(`/admin/stock/assets/outbound/${id}`, data)
export const deleteStockOutbound = (id: number) =>
    api.delete(`/admin/stock/assets/outbound/${id}`)
...
export const createStockCount = (data: any) =>
    api.post('/admin/stock/assets/counts', data)
export const updateStockCount = (id: number, data: any) =>
    api.put(`/admin/stock/assets/counts/${id}`, data)
export const deleteStockCount = (id: number) =>
    api.delete(`/admin/stock/assets/counts/${id}`)

// Gift Categories
export const listGiftCategories = (companyId: number) =>
    api.get('/admin/stock/gifts/categories', { params: { company_id: companyId } })
export const createGiftCategory = (data: any) =>
    api.post('/admin/stock/gifts/categories', data)
export const updateGiftCategory = (id: number, data: any) =>
    api.put(`/admin/stock/gifts/categories/${id}`, data)
export const deleteGiftCategory = (id: number) =>
    api.delete(`/admin/stock/gifts/categories/${id}`)

// Stock Gifts
export const listStockGifts = (companyId: number, categoryId?: number) =>
    api.get('/admin/stock/gifts', { params: { company_id: companyId, ...(categoryId ? { category_id: categoryId } : {}) } })
export const createStockGift = (data: any) =>
    api.post('/admin/stock/gifts', data)
export const updateStockGift = (id: number, data: any) =>
    api.put(`/admin/stock/gifts/${id}`, data)
export const deleteStockGift = (id: number) =>
    api.delete(`/admin/stock/gifts/${id}`)

// Gift Purchases
export const listGiftPurchases = (companyId: number) =>
    api.get('/admin/stock/gifts/purchases', { params: { company_id: companyId } })
export const createGiftPurchase = (data: any) =>
    api.post('/admin/stock/gifts/purchases', data)
export const updateGiftPurchase = (id: number, data: any) =>
    api.put(`/admin/stock/gifts/purchases/${id}`, data)
export const deleteGiftPurchase = (id: number) =>
    api.delete(`/admin/stock/gifts/purchases/${id}`)
...
export const createGiftRequisition = (data: any) =>
    api.post('/admin/stock/gifts/requisitions', data)
export const updateGiftRequisition = (id: number, data: any) =>
    api.put(`/admin/stock/gifts/requisitions/${id}`, data)
export const deleteGiftRequisition = (id: number) =>
    api.delete(`/admin/stock/gifts/requisitions/${id}`)
...
export const createGiftInbound = (data: any) =>
    api.post('/admin/stock/gifts/inbound', data)
export const updateGiftInbound = (id: number, data: any) =>
    api.put(`/admin/stock/gifts/inbound/${id}`, data)
export const deleteGiftInbound = (id: number) =>
    api.delete(`/admin/stock/gifts/inbound/${id}`)
...
export const createGiftOutbound = (data: any) =>
    api.post('/admin/stock/gifts/outbound', data)
export const updateGiftOutbound = (id: number, data: any) =>
    api.put(`/admin/stock/gifts/outbound/${id}`, data)
export const deleteGiftOutbound = (id: number) =>
    api.delete(`/admin/stock/gifts/outbound/${id}`)
...
// ═══════════ 服务器管理 ═══════════
export const listServers = (companyId: number) =>
    api.get('/servers/', { params: { company_id: companyId } })
...
export const listServices = (serverId: number) =>
    api.get(`/servers/${serverId}/services`)
export const createService = (serverId: number, data: any) =>
    api.post(`/servers/${serverId}/services`, data)
export const updateService = (id: number, data: any) =>
    api.put(`/servers/services/${id}`, data)
export const deleteService = (id: number) =>
    api.delete(`/servers/services/${id}`)
...
export const setUserPermissions = (userId: number, data: any) =>
...
export const createCarryForward = (data: {
  company_id: number; period: string; entry_type: string
  debit_account_id?: number; credit_account_id?: number; amount: number
}) => api.post('/periods/carry-forward', data)

export const executeCarryForward = (entryId: number) =>
  api.post(`/periods/carry-forward/${entryId}/execute`)

export const deleteCarryForward = (entryId: number) =>
  api.delete(`/periods/carry-forwards/${entryId}`)
