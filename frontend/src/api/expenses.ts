...
export const listExpenseItems = (companyId: number) => api.get('/expenses/items', { params: { company_id: companyId } })
...
export const deleteExpensePolicy = (policyId: number) => api.delete(`/expenses/policies/${policyId}`)
...
export const getExpenseReport = (reportId: number) => api.get(`/expenses/reports/${reportId}`)
...
export const getReportItems = (reportId: number) => api.get(`/expenses/reports/${reportId}/items`)

// ── 审批操作 ──

export const submitReport = (reportId: number) => api.post(`/expenses/reports/${reportId}/submit`)
...
export const payReport = (reportId: number) => api.post(`/expenses/reports/${reportId}/pay`)

export const cancelReport = (reportId: number) => api.post(`/expenses/reports/${reportId}/cancel`)

// ── 借款管理 ──

export const listExpenseLoans = (companyId: number) => api.get('/expenses/loans', { params: { company_id: companyId } })
...
export const approveLoan = (loanId: number) => api.post(`/expenses/loans/${loanId}/approve`)
...
export const listAttachments = (reportId: number) => api.get(`/expenses/reports/${reportId}/attachments`)
...
export const deleteAttachment = (attachmentId: number) => api.delete(`/expenses/attachments/${attachmentId}`)
...
export const bypassReport = (id: number, reason: string) => api.post(`/expenses/reports/${id}/bypass`, { reason })

export const bypassLoan = (id: number, reason: string) => api.post(`/expenses/loans/${id}/bypass`, { reason })
