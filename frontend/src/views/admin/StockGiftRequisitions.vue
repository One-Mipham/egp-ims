...
<template>
  <div>
    <div class="flex justify-end mb-4"><Button :label="`${t('common.add')}${t('admin.giftRequisition')}`" icon="pi pi-plus" @click="openCreate" /></div>
    <div class="bg-white rounded-sm border border-stone-200 overflow-x-auto">
      <DataTable :value="items" :loading="loading" stripedRows size="small" paginator :rows="15">
        ...
        <Column field="department" :header="t('admin.department')" />
