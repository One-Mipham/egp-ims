  ...
  <div>
    ...
    <Dialog v-model:visible="showDialog" :header="editing ? '编辑培训' : '新增培训'" :style="{ width: '480px' }">
      <div class="flex flex-col gap-3 py-4">
        ...
        <div>
          <label class="block text-xs text-zinc-500 mb-1">培训名称 *</label
        ...
        <div>
          <label class="block text-xs text-zinc-500 mb-1">培训机构</label
          ><InputText v-model="form.provider" class="w-full" />
        </div>
        <div>
          <label class="block text-xs text-zinc-500 mb-1">费用</label
