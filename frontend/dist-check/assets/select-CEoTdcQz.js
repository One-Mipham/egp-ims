...
`,classes:{root:`p-iconfield`}}),provide:function(){return{$pcIconField:this,$parentInstance:this}}},inheritAttrs:!1};function Le(e,t,r,a,o,s){return i(),_(`div`,v({class:e.cx(`root`)},e.ptmi(`root`)),[n(e.$slots,`default`)],16)}U.render=Le;var W={name:`InputIcon`,extends:{name:`BaseInputIcon`,extends:I,style:A.extend({name:`inputicon`,classes:{root:`p-inputicon`}}),props:{class:null},provide:function(){return{$pcInputIcon:this,$parentInstance:this}}},inheritAttrs:!1,computed:{containerClass:function(){return[this.cx(`root`),this.class]}}};function Re(e,t,r,a,o,s){return i(),_(`span`,v({class:s.containerClass},e.ptmi(`root`),{"aria-hidden":`true`}),[n(e.$slots,`default`)],16)}W.render=Re;var G=A.extend({name:`virtualscroller`,css:`
.p-virtualscroller {
    position: relative;
    overflow: auto;
    contain: strict;
