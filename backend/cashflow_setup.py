...
from app.models import Voucher, VoucherEntry, Account, CashFlowItem  # noqa: E402
...
items = [
    ...
    (
        ...
        "1122,6001",
    ),  # when receivables credited or revenue credited
...
for code in cf_order:
    ...
    if may_sys or may_xl or ytd_sys or ytd_xl:
        ...
        print(
            f"  {name:40s} May: sys={may_sys:>12,.2f} xl={may_xl:>12,.2f} diff={d_may:>10,.2f}  |  YTD: sys={ytd_sys:>12,.2f} xl={ytd_xl:>12,.2f} diff={d_ytd:>10,.2f}"  # noqa: E501
        )
